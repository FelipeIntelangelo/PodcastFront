  ...
  loadNovedades(): void {
    ...
    this.podcastService.getAll(false).subscribe({
      ...
      error: (error) => {
        ...
        this.alertService.error('Error', 'Error al cargar las novedades');
        this.isLoading.novedades = false;
      }
    });
  }
  ...
  loadMasEscuchados(): void {
    ...
    this.podcastService.getAll(true).subscribe({
      ...
      error: (error) => {
        ...
        this.alertService.error('Error', 'Error al cargar los más escuchados');
        this.isLoading.masEscuchados = false;
      }
    });
  }
  ...
  loadMejoresValorados(): void {
    ...
    this.podcastService.getAll(false).subscribe({
      ...
      error: (error) => {
        ...
        this.alertService.error('Error', 'Error al cargar los mejores valorados');
        this.isLoading.mejoresValorados = false;
      }
    });
  }
